/**
 * STJacobs Orthanc DICOM Viewer Configuration
...
window.config = {
  ...
  defaultDataSourceName: 'stjacobs',
  ...
  ui: {
    whiteLabeling: {
      ...
      menuTitle: 'STJacobs DICOM Viewer',
    },
  },
  ...
  dataSources: [
    {
      ...
      sourceName: 'stjacobs',
      configuration: {
        friendlyName: 'STJacobs Orthanc DICOM Server',
        name: 'STJacobs',
        // Ajusta estas URLs según tu instalación de Orthanc
        // Por ejemplo: http://stjacobs.hospital.local:8042/dicom-web
        // O si está en un proxy inverso: http://stjacobs.hospital.local/orthanc/dicom-web
