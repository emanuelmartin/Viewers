      ...
      >
        {thumbnailItems.length > 0 && (
          <div
            ...
            className="bg-background grid lg:grid-cols-[repeat(auto-fit,_minmax(0,135px))] grid-cols-[repeat(auto-fit,_minmax(0,100px))] place-items-start gap-[4px] lg:gap-[4px] gap-[2px]"
          >
